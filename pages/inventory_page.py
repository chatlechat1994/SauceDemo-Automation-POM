...
class InventoryPage:
    def __init__(self, driver):
        self.driver = driver
        # 📍 The Map: Finding the backpack and the cart icon
        # We use 'selectors' so we only have to change them here if the site updates
        self.backpack_add_button = (By.ID, "add-to-cart-sauce-labs-backpack")
        self.cart_icon = (By.CLASS_NAME, "shopping_cart_link")

    # 🤚 The Actions: What the user actually does on this page
